...
_DS_NAME = "spider"
_URL = "https://www.dropbox.com/scl/fi/iim8r68lwqd4mp1jaflr8/spider.tgz?rlkey=v4wiyv2mn5q5jnso98aqgnaav&st=tjhx7axu&dl=1"
...
class Spider(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager: datasets.DownloadManager) -> List[datasets.SplitGenerator]:
        ...
        if downloaded_filepath is None or not pathlib.Path(downloaded_filepath).joinpath(dataset_name).exists():
