...
from seq2seq.utils.postgre_schema_extractor import extract_table_schema_from_postgres
...
_FILEPATH = pathlib.Path("data/synthea_clean").resolve()
...
class SpiderSSC(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager: datasets.DownloadManager) -> List[datasets.SplitGenerator]:
        ...
        self.schema_extractor = {
            ...
            "postgresql": extract_table_schema_from_postgres,
        }
                ...
                for sample in spider_joint:
                    ...
                    if lang == "sql":
                        ...
                        data_dict.update({
                            ...
                            "db_primary_keys": [{"column_id": column_id} for column_id in schema["primary_keys"]],
                            "db_foreign_keys": [
                                {"column_id": fk[0][1], "other_column_id": fk[1][1]}
