...
python -m seq2seq.run_seq2seq configs/5_ut5-ep19-c4-clean-pool6x/cypher_compact.json
python -m seq2seq.run_seq2seq configs/5_ut5-ep19-c4-clean-pool6x/sql_compact.json
python -m seq2seq.run_seq2seq configs/5_ut5-ep19-c4-clean-pool6x/sparql_compact.json
python -m seq2seq.run_seq2seq configs/5_ut5-ep19-c4-clean-pool6x/sql_norange.json
python -m seq2seq.run_seq2seq configs/5_ut5-ep19-c4-clean-pool6x/sparql_norange.json
python -m seq2seq.run_seq2seq configs/5_ut5-ep19-c4-clean-pool6x/cypher_norange.json
python -m seq2seq.run_seq2seq configs/5_ut5-ep19-c4-clean-pool6x/sql_no-schema.json
python -m seq2seq.run_seq2seq configs/5_ut5-ep19-c4-clean-pool6x/sparql_no-schema.json
python -m seq2seq.run_seq2seq configs/5_ut5-ep19-c4-clean-pool6x/cypher_no-schema.json
