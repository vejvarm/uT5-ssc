...
python -m seq2seq.run_seq2seq configs/5_ut5-ep19-dirty_v2/cypher_compact.json  # DONE 800 v1 TODO 800 v2
python -m seq2seq.run_seq2seq configs/5_ut5-ep19-dirty_v2/sql_compact.json  # DONE 800 v1 TODO 800 v2
python -m seq2seq.run_seq2seq configs/5_ut5-ep19-dirty_v2/sparql_compact.json  # DONE 800 v1 TODO 800 v2
# python -m seq2seq.run_seq2seq configs/5_ut5-ep19-dirty_v2/sql_norange.json  # DONE
# python -m seq2seq.run_seq2seq configs/5_ut5-ep19-dirty_v2/sparql_norange.json  # TODO
# python -m seq2seq.run_seq2seq configs/5_ut5-ep19-dirty_v2/cypher_norange.json  # TODO
# python -m seq2seq.run_seq2seq configs/5_ut5-ep19-dirty_v2/sql_no-schema.json   # TODO
# python -m seq2seq.run_seq2seq configs/5_ut5-ep19-dirty_v2/sparql_no-schema.json   # TODO
# python -m seq2seq.run_seq2seq configs/5_ut5-ep19-dirty_v2/cypher_no-schema.json   # TODO