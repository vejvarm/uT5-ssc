...
# python -m seq2seq.run_seq2seq configs/10_train_t5-single/cypher_compact.json  # DONE
# python -m seq2seq.run_seq2seq configs/10_train_t5-single/cypher_norange.json  # DONE
