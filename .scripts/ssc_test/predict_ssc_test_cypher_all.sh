...
# Run predictions on test set with uT5-dirty models
# python -m seq2seq.run_seq2seq configs/8_predict/clean/cypher_no-schema.json  # DONE
# python -m seq2seq.run_seq2seq configs/8_predict/clean/cypher_norange.json  # DONE
# python -m seq2seq.run_seq2seq configs/8_predict/clean/cypher_compact.json  # DONE
python -m seq2seq.run_seq2seq configs/8_predict/dirty/cypher_compact.json  # DONE
python -m seq2seq.run_seq2seq configs/8_predict/injected10p/cypher_compact.json  # DONE
python -m seq2seq.run_seq2seq configs/8_predict/injected30p/cypher_compact.json  # DONE
python -m seq2seq.run_seq2seq configs/8_predict/cypher_long/cypher_compact_1024.json  # DONE
python -m seq2seq.run_seq2seq configs/8_predict/cypher_long/cypher_compact_2048.json  # DONE
python -m seq2seq.run_seq2seq configs/8_predict/cypher_long/cypher_norange_1024.json  # DONE
python -m seq2seq.run_seq2seq configs/8_predict/cypher_long/cypher_norange_2048.json  # DONE
python -m seq2seq.run_seq2seq configs/8_predict/cypher_long/cypher_norange_2048.json  # DONE
python -m seq2seq.run_seq2seq configs/8_predict/cypher_short/cypher_compact_short.json
python -m seq2seq.run_seq2seq configs/8_predict/cypher_short/cypher_compact_strip_root_only.json
python -m seq2seq.run_seq2seq configs/8_predict/cypher_short/cypher_norange_short.json
python -m seq2seq.run_seq2seq configs/8_predict/cypher_short/cypher_norange_strip_root_only.json
