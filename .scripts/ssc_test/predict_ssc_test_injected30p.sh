...
# Run predictions on test set with uT5-injected30p models
# python -m seq2seq.run_seq2seq configs/8_predict/injected30p/sql_norange.json
# python -m seq2seq.run_seq2seq configs/8_predict/injected30p/sparql_norange.json
