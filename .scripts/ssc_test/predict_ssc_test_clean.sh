...
# python -m seq2seq.utils.rdf_schema_extractor test --ds-path /home/vejvar-martin-nj/git/uT5-ssc/data/ssc_test --clean --dump-schema
...
python -m seq2seq.run_seq2seq configs/8_predict/clean/sql_norange.json
python -m seq2seq.run_seq2seq configs/8_predict/clean/sparql_norange.json
python -m seq2seq.run_seq2seq configs/8_predict/clean/cypher_norange.json
python -m seq2seq.run_seq2seq configs/8_predict/clean/sql_compact.json
python -m seq2seq.run_seq2seq configs/8_predict/clean/sparql_compact.json
python -m seq2seq.run_seq2seq configs/8_predict/clean/cypher_compact.json
python -m seq2seq.run_seq2seq configs/8_predict/clean/sql_no-schema.json
python -m seq2seq.run_seq2seq configs/8_predict/clean/sparql_no-schema.json 
python -m seq2seq.run_seq2seq configs/8_predict/clean/cypher_no-schema.json 
