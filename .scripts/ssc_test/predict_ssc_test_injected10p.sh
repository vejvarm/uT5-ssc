...
# python -m seq2seq.utils.rdf_schema_extractor test --ds-path /home/vejvar-martin-nj/git/uT5-ssc/data/ssc_test --injected10p --dump-schema
...
# Run predictions on test set with uT5-injected10p models
# python -m seq2seq.run_seq2seq configs/8_predict/injected10p/sql_norange.json
# python -m seq2seq.run_seq2seq configs/8_predict/injected10p/sparql_norange.json
# python -m seq2seq.run_seq2seq configs/8_predict/injected10p/cypher_norange.json
python -m seq2seq.run_seq2seq configs/8_predict/injected10p/sql_compact.json
python -m seq2seq.run_seq2seq configs/8_predict/injected10p/sparql_compact.json
python -m seq2seq.run_seq2seq configs/8_predict/injected10p/cypher_compact.json
# python -m seq2seq.run_seq2seq configs/8_predict/injected10p/sql_no-schema.json
# python -m seq2seq.run_seq2seq configs/8_predict/injected10p/sparql_no-schema.json 
# python -m seq2seq.run_seq2seq configs/8_predict/injected10p/cypher_no-schema.json 
