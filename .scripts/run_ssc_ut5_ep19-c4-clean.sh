...
python -m seq2seq.run_seq2seq configs/5_ut5-ep19-c4-clean/cypher_compact.json
python -m seq2seq.run_seq2seq configs/5_ut5-ep19-c4-clean/sql_compact.json
python -m seq2seq.run_seq2seq configs/5_ut5-ep19-c4-clean/sparql_compact.json
python -m seq2seq.run_seq2seq configs/5_ut5-ep19-c4-clean/sql_norange.json
python -m seq2seq.run_seq2seq configs/5_ut5-ep19-c4-clean/sparql_norange.json
python -m seq2seq.run_seq2seq configs/5_ut5-ep19-c4-clean/cypher_norange.json
python -m seq2seq.run_seq2seq configs/5_ut5-ep19-c4-clean/sql_no-schema.json
python -m seq2seq.run_seq2seq configs/5_ut5-ep19-c4-clean/sparql_no-schema.json
python -m seq2seq.run_seq2seq configs/5_ut5-ep19-c4-clean/cypher_no-schema.json
