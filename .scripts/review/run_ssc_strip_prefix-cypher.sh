...
python -m seq2seq.run_seq2seq configs/7_ut5-ep19-short_cypher/cypher_compact.json  # TODO
python -m seq2seq.run_seq2seq configs/7_ut5-ep19-short_cypher/cypher_compact_dirty.json  # TODO
python -m seq2seq.run_seq2seq configs/7_ut5-ep19-short_cypher/cypher_compact_injected.json  # TODO
python -m seq2seq.run_seq2seq configs/7_ut5-ep19-short_cypher/cypher_compact_injected-30p.json  # TODO
python -m seq2seq.run_seq2seq configs/7_ut5-ep19-short_cypher/cypher_norange.json  # TODO
python -m seq2seq.run_seq2seq configs/7_ut5-ep19-short_cypher/cypher_norange_dirty.json  # TODO
python -m seq2seq.run_seq2seq configs/7_ut5-ep19-short_cypher/cypher_norange_injected.json  # TODO
python -m seq2seq.run_seq2seq configs/7_ut5-ep19-short_cypher/cypher_norange_injected-30p.json  # TODO