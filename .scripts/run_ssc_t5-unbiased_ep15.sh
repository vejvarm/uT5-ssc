...
python seq2seq/run_seq2seq.py configs/5_unbiased-t5-ep15/cypher_compact.json  # DONE 800
python seq2seq/run_seq2seq.py configs/5_unbiased-t5-ep15/sql_compact.json  # DONE 800
python seq2seq/run_seq2seq.py configs/5_unbiased-t5-ep15/sparql_compact.json  # DONE 800
# python seq2seq/run_seq2seq.py configs/5_unbiased-t5-ep15/sql_norange.json  # DONE
# python seq2seq/run_seq2seq.py configs/5_unbiased-t5-ep15/sparql_norange.json  # TODO
# python seq2seq/run_seq2seq.py configs/5_unbiased-t5-ep15/cypher_norange.json  # TODO
# python seq2seq/run_seq2seq.py configs/5_unbiased-t5-ep15/sql_no-schema.json   # TODO
# python seq2seq/run_seq2seq.py configs/5_unbiased-t5-ep15/sparql_no-schema.json   # TODO
# python seq2seq/run_seq2seq.py configs/5_unbiased-t5-ep15/cypher_no-schema.json   # TODO