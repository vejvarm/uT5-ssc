...
python -m seq2seq.run_seq2seq configs/5_unbiased-t5-ep12/sql_compact.json
python -m seq2seq.run_seq2seq configs/5_unbiased-t5-ep12/sparql_compact.json
python -m seq2seq.run_seq2seq configs/5_unbiased-t5-ep12/cypher_compact.json
python -m seq2seq.run_seq2seq configs/5_unbiased-t5-ep12/sql_norange.json
python -m seq2seq.run_seq2seq configs/5_unbiased-t5-ep12/sparql_norange.json
python -m seq2seq.run_seq2seq configs/5_unbiased-t5-ep12/cypher_norange.json
python -m seq2seq.run_seq2seq configs/5_unbiased-t5-ep12/sql_no-schema.json
python -m seq2seq.run_seq2seq configs/5_unbiased-t5-ep12/sparql_no-schema.json
python -m seq2seq.run_seq2seq configs/5_unbiased-t5-ep12/cypher_no-schema.json