...
python seq2seq/run_seq2seq.py configs/6_ut5-ep19-clean_eval/sparql_compact.json  
python seq2seq/run_seq2seq.py configs/6_ut5-ep19-clean_eval/cypher_compact.json
python seq2seq/run_seq2seq.py configs/6_ut5-ep19-clean_eval/sql_compact.json  
# python seq2seq/run_seq2seq.py configs/6_ut5-ep19-clean_eval/sql_norange.json  # TODO
# python seq2seq/run_seq2seq.py configs/6_ut5-ep19-clean_eval/sparql_norange.json  # TODO
# python seq2seq/run_seq2seq.py configs/6_ut5-ep19-clean_eval/cypher_norange.json  # TODO
# python seq2seq/run_seq2seq.py configs/6_ut5-ep19-clean_eval/sql_no-schema.json   # TODO
# python seq2seq/run_seq2seq.py configs/6_ut5-ep19-clean_eval/sparql_no-schema.json   # TODO
# python seq2seq/run_seq2seq.py configs/6_ut5-ep19-clean_eval/cypher_no-schema.json   # TODO